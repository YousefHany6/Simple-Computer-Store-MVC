...
namespace Computer_Store.Areas.Identity.Pages.Account.Manage
{
   ...
   ///     directly from your code. This API may change or be removed in future releases.
   /// </summary>
   [Required(ErrorMessage = "ادخل كلمة مرور الحالية")]
   [DataType(DataType.Password)]
            ...
            ///     directly from your code. This API may change or be removed in future releases.
            /// </summary>
            [Required(ErrorMessage ="ادخل كلمة مرور جديدة")]
            ...
            [Compare("NewPassword", ErrorMessage = "كلمة المرور الجديدة وكلمة مرور الحالية غير متطابقتين.")]
